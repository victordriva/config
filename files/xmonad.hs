...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,20), (R,20), (U,30), (D,30)]) -- reset the GapSpec
...
myStartupHook = do
  ...
  spawnOnce "xrandr --output DP-4 --mode 2560x1440 --rate 169.83 --primary --output HDMI-0 --mode 1920x1080 --rate 144 --left-of DP-4"
